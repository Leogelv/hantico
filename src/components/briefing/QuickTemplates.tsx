...
export function QuickTemplates({ isVisible, onSelectTemplate }: QuickTemplatesProps) {
  return (
    <AnimatePresence>
      {isVisible && (
        <motion.div
          className="px-3 sm:px-4 py-3 sm:py-4 bg-white border-t border-red-200/30"
                ...
                >
                  <TouchFeedback>
                    <Button
                      variant="outline"
                      size="sm"
                      className="justify-start text-left h-auto p-3 text-xs sm:text-sm hover:bg-red-50 hover:border-red-300 border-gray-200 w-full min-h-[44px] touch-manipulation"
